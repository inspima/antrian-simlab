    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Work Group</h4>
            </div>
        </div>
    </div>
        ...
        $(document).ready(function () {
            $('#datatable').DataTable({
                ...
                "columns": [
                    ...
                    {data: 'shift_name', title: 'Shift Name', orderable: true, searchable: true},
                    {
                    ...
                    {data: 'name', title: 'Work Group Name', orderable: true, searchable: true},
                    {
