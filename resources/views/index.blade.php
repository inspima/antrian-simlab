                            ...
                            <div class="row">
                                            ...
                                            <div class="inbox-widget">
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" class="rounded-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" class="rounded-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" class="rounded-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" class="rounded-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" class="rounded-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" class="rounded-circle" alt=""></div>
                                ...
                                <div class="col-xl-4">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            <div class="media">
                                                <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="Generic placeholder image">
                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <div class="media">
                                                <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="Generic placeholder image">
                                                <div class="media-body">
