...
Route::group(['prefix' => 'sample'], function () {
    ...
    Route::get('/{key}/print', 'RegistrationSampleController@print')->name('registration.sample.print');
    Route::get('/{key}/print-result', 'RegistrationSampleController@printResult')->name('registration.sample.print-result');
